...
<link href="{$arg.stylesheet}css/TimeCircles.css" rel="stylesheet">
...
<script src="{$arg.stylesheet}js/TimeCircles.js" type="text/javascript"></script>
