...
<div class="list-group list-group-flush">
	...
	<a href="#" class="list-group-item list-group-item-action"><i class="fa fa-fw fa-heart-o"></i> Sản phẩm quan tâm</a>
	...
	<a href="#" class="list-group-item list-group-item-action"><i class="fa fa-fw fa-envelope-o"></i> Tin nhắn và liên hệ</a>
