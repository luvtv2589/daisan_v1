									...
									<li>
										<div id="nav-top-right" class="pt-1">
											<ul class="navbar-nav">
												...
												<li class="nav-item active"><a href="javascript:void(0)"
													class="link-black">Tải ứng dụng</a></li>
											</ul>
										</div>
									</li>
								</ul>
					...
					<ul class="">
						<li class="nav-item w-33">
							...
							<div class="dropdown-menu-right">
								...
								{else}
								<div class="mydaisan">
									<a href="?mod=account&site=index" class="link-black px-3 first">Hi,
										{$user.name|default:''}</a>
									<div class="px-3">
						...
						<li class="nav-item w-33">
							<div class="nav-item-child">
								...
								<div class="main-head__title-bottom">
									<a class="link-black" href="?mod=account&site=productfavorites">
										Yêu thích</a>
								</div>
							</div>
							<div class="dropdown-menu-right">
