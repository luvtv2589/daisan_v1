<div class="S-2">
	<div class="header-deal"
		style="background: url('{$event.banner}') no-repeat center 0">
		<div class="container">
					...
					<div class="col-sm-3 col-6 mb-2">
						<div class="card">
							<a href="{$data.url}"><img src="{$data.avatar}"
								alt="Card image cap" class="d-block w-100 p-3"></a>
							<div class="card-body pt-0">
								...
								<span class="btn btn-outline-danger">{$data.percent} OFF</span>
								<a href="{$data.url}" class="btn btn-primary btn-cart-event">Xem chi tiết</a>
							</div>
						</div>
					</div>
					{/foreach}
	...
	<div class="container p-0 main-category-hot d-block d-sm-none">
		<div class="product">
