...
//                 $this->send_mail($email, $mail_title, $mail_content);
    ...
    function ajax_handle(){
        if(isset($_POST['ajax_action']) && $_POST['ajax_action']=='upload_images'){
            ...
            //Thêm thông tin ảnh call vào api---------
            ...
            $data_images['name_file_upload'] = 'upload_news/' . $page_id;
...
//             die();
            ...
            // Call api resize image-----------
            $result_api = json_decode($this->callAPI(DOMAIN_API.'resize-image', json_encode($data_images), 'POST'), true);
