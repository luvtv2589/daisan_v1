...
<div class="row">
	<div class="col-md-8">
	    <div class="form-group form-inline">
	        ...
	        <select class="left form-control" id="status" title="status">{$out.filter_status}</select>
                ...
                <tr id="field{$data.id}">
                    ...
                    <td width="50%">
                    	<div class="row row-small">
                    		<div class="col-md-2">
                    			<img class="img" id="img{$data.id}" src="{$data.avatar}" onclick="ViewImage('{$data.media_id}', {$data.id});">
                    		</div>
                    		<div class="col-md-10">
		                        <a href="?mod=posts&site=event_detail&post_id={$data.id}">{$data.title}</a><br>
