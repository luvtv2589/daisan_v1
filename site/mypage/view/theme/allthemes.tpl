		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="p-3 text-right">
					<button type="button" onclick="SetTheme({$data.id});" class="btn btn-success">Sử dụng</button>
...
function SetTheme(id){
	var Data = {};
	Data['ajax_action'] = "set_theme";
	Data['id'] = id;
	loading();
	$.post('?mod=theme&site=allthemes', Data).done(function(e){
		endloading();
		location.reload();
	});
}
