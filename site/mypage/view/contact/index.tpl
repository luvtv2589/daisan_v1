...
<div class="card-group">
	<div class="card rounded-0" style="flex-grow: 0.50">
	...
	<div class="card rounded-0">
		...
		<div class="p-3">
			<div class="row row-sm">
				...
				<div class="col-md-11">
					<p class="my-1"><b>{$info.name}</b> gửi liên hệ tới gian hàng</p>
					...
					<div class="border-dashed p-2">
						<div class="row row-sm">
							...
							<div class="col-md-11">
								...
								<p class="text-small">Số lượng: {$info.number}&nbsp;{$info.unit}</p>
							</div>
						</div>
					</div>
					{/if}
