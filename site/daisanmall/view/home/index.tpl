<div {if $is_mobile}class="bg-white"{/if}>
		...
		<div class="container-small">
			<div class="row">
				<div class="col-xl-4 col-md-3 align-self-center d-none d-sm-block">
					<img
						src="{$arg.stylesheet}images/logo-daisanmall.png"
						height="35px">
				</div>
	...
	<div class="">
		<div class="container-small">
			...
			<h3 class="py-3">Cửa hàng dành cho bạn</h3>
								...
								<div class="card-header p-2 bg-white">
									<div class="media">
										...
										<div class="media-body">
											...
											<img
												src="{$arg.stylesheet}images/daisanmall.png">
										</div>
										<div class="d-block d-sm-none">
								...
								<div class="card-body bg-light">
									<div class="row row-sm">
										...
										<div class="col-xl-3 col-3">
											<a href="{$list.url}"><img src="{$list.avatar}" class="card-img-top" alt="{$list.name}"></a>
										</div>
										{/foreach}
									</div>
									<!-- end card-deck -->
