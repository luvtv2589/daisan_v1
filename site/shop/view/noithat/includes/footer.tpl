            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <ul class="list-menu">
                            <li>
                                <a href=""> <i class="fa fa-map-marker pr-3 text-success"></i>Địa chỉ: {$page.address}</a>
                            </li>
                            <li>
                                <a href=""> <i class="fa fa-phone pr-3 text-success"></i>Điện thoại: {$page.phone}</a>
                            </li>
                            <li>
                                <a href=""><i class="pr-3 fa fa-envelope text-success"></i>Email: {$page.email}</a>
                            </li>
                    ...
                    <div class="col-12 col-lg-3">
                        ...
                        <ul class="list-menu pl-2">
                            <li><a href="{$a_main_menu.home}"><i class="fa fa-angle-right pr-2 text-success"></i>Trang chủ</a></li>
						<li><a href="{$a_main_menu.company_information}"><i class="fa fa-angle-right pr-2 text-success"></i>Về chúng tôi</a></li>
						<li><a href=""><i class="fa fa-angle-right pr-2 text-success"></i>Tất cả dịch vụ</a></li>
						<li><a href=""><i class="fa fa-angle-right pr-2 text-success"></i>Tuyển dụng</a></li>
						<li><a href="{$a_main_menu.contact}"><i class="fa fa-angle-right pr-2 text-success"></i>Liên hệ</a></li>
                        </ul>
                    </div>
                    <div class="col-12 col-lg-3">
                        <h4 class="title mt-5">
