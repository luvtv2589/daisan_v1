...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-54567873-8"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-54567873-8');
</script>
 {/literal}   
</head>
<body>
	...
	<section id="main">
		<div class="container">
			<div class="bg-white">
				<div class="bg-transparent">{$a_main_breadcrumb}</div>
