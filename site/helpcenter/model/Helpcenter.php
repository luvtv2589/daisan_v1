...
class Helpcenter {
    ...
    function __construct() {
        ...
        $this->arg = array(
            'stylesheet' => DOMAIN . "site/helpcenter/webroot/",
    		'timenow' => time(),
            'domain' => DOMAIN,
            'thislink' => THIS_LINK,
            'mod' => $mod,
            ...
            'url_page' => URL_HELPCENTER
        );
        
        $this->get_seo_metadata();
        
        $this->smarty->assign('a_main_category', $this->tax->get_taxonomy('support', 0, null, null, 1));
    ...
    function get_breadcrumb($taxonomy_id){
        ...
        $str .= "<li class=\"breadcrumb-item\"><a href=\"./\">Help Center</a></li>";
